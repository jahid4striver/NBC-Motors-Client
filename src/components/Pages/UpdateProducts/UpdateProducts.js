            ...
            <div className='container my-5 grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4'>
                ...
                <div>
                    <form onSubmit={handleAddQyt}>
                        ...
                        <button type="submit" className="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Quantity</button>
                    </form>
                </div>
            </div>
        </div>
